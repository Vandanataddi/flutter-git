...
class DonutChartWidget extends StatefulWidget {
  DonutChartWidget({@required this.templateJson, @required this.listData});
...
class _ScreenState extends State<DonutChartWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return SfCircularChart(
        ...
        legend: legend,
        series: <DoughnutSeries<PieChartSampleData, String>>[
          DoughnutSeries<PieChartSampleData, String>(
              radius: "90%",
              explode: true,
              explodeIndex: 0,
              explodeOffset: '10%',
